 ...
 */
final class Version20230131071656 extends AbstractMigration
{
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE distribuicion (id INT AUTO_INCREMENT NOT NULL, mesa_id_id INT NOT NULL, posicion_x INT NOT NULL, posicion_y INT NOT NULL, fecha DATETIME NOT NULL, reservada TINYINT(1) DEFAULT NULL, INDEX IDX_848A6F79AC72117 (mesa_id_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
